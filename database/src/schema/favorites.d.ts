 ...
 */
export declare const favoriteFolders: import("drizzle-orm/pg-core").PgTableWithColumns<{
 ...
 * Note: auth-dependent, temporarily disabled in API layer but table structure preserved.
 */
export declare const recipeRatings: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "recipe_ratings";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
