        ...
        <div class="px-4 -mt-6 relative">
          ...
          <div class="bg-white dark:bg-stone-800 rounded-t-3xl shadow-lg p-5">
            <div class="flex items-start justify-between gap-3 mb-3">
              <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-stone-100 leading-tight flex-1">
                {{ recipe.title }}
              </h1>
              <span
                :class="[
                  'px-2.5 py-1 rounded-full text-xs font-semibold uppercase shrink-0',
            ...
            <div class="grid grid-cols-4 gap-2 mb-4">
              ...
              <div class="text-center p-2 bg-blue-50 dark:bg-blue-900/30 rounded-xl">
              ...
              <div class="text-center p-2 bg-green-50 dark:bg-green-900/30 rounded-xl">
                <p class="text-lg mb-0.5">🥬</p>
              ...
              <div class="text-center p-2 bg-purple-50 dark:bg-purple-900/30 rounded-xl">
                <p class="text-lg mb-0.5">🍳</p>
