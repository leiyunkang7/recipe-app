...
/**
 * StarRatingIcon - Star icon for rating displays
 *
 * Supports filled and outlined states via a single SVG,
 * avoiding duplicate inline SVGs in templates.
 */
import type { FilledIconProps } from '~/types/component-props'

const props = withDefaults(defineProps<FilledIconProps>(), {
  filled: true,
})
</script>
