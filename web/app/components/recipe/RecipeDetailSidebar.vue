...
<template>
  ...
  <div class="space-y-6">
    ...
    <!-- Nutrition Info Card -->
    <div v-if="recipe.nutritionInfo" class="bg-white dark:bg-stone-800 rounded-xl shadow-md p-6">
      <h2 class="text-xl font-bold text-gray-900 dark:text-stone-100 mb-4 flex items-center gap-2">
        🥗 {{ t('recipe.nutritionInfo') }}
      </h2>
      <div class="grid grid-cols-2 gap-4">
        <div v-if="recipe.nutritionInfo.calories" class="text-center p-3 bg-red-50 dark:bg-red-900/30 rounded-lg">
        ...
        <div v-if="recipe.nutritionInfo.protein" class="text-center p-3 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
          <p class="text-2xl mb-1">💪</p>
        ...
        <div v-if="recipe.nutritionInfo.carbs" class="text-center p-3 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg">
          <p class="text-2xl mb-1">🍞</p>
        ...
        <div v-if="recipe.nutritionInfo.fat" class="text-center p-3 bg-purple-50 dark:bg-purple-900/30 rounded-lg">
          <p class="text-2xl mb-1">🧈</p>
        ...
        <div v-if="recipe.nutritionInfo.fiber" class="text-center p-3 bg-green-50 dark:bg-green-900/30 rounded-lg col-span-2">
          <p class="text-2xl mb-1">🌾</p>
