...
<template>
  <div ref="menuRef" class="relative inline-block">
    ...
    >
      <div
        v-if="showMenu"
        class="absolute left-0 right-auto sm:left-auto sm:right-0 mt-2 w-[288px] max-w-[calc(100vw-16px)] sm:max-w-[288px] bg-white dark:bg-stone-800 rounded-xl shadow-xl border border-stone-200 dark:border-stone-700 z-50 overflow-hidden"
      >
        <!-- 标题 -->
