// Supabase Edge Function: send-author-notification
// Triggered when a new recipe is inserted to notify author subscribers
  ...
  async sendNewRecipeEmail(
    ...
    try {
      await this.transporter.sendMail({
        ...
        to: email,
        subject: "New recipe published by " + notification.authorName + ": " + notification.title,
...
serve(async (_req) => {
  ...
  try {
    ...
    console.error("Error in send-author-notification:", error);
    return new Response(
